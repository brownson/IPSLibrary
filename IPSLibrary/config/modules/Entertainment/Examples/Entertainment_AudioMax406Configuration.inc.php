<?
	...
	define ("c_Room_5",									"Raum 5");
	define ("c_Room_6",									"Raum 6");
	...
	define ("c_Device_AudioMax5",						"AudioMax5");
	define ("c_Device_AudioMax6",						"AudioMax6");
	...
	function get_RoomConfiguration () {
	   return array (
	      ...
	      // -------------------------------------------------------------------------------------------------------
			c_Room_5 => array(
				c_Property_Name 			=> AM_CONFIG_ROOMNAME5,
				c_Control_RoomPower 		=> array(c_Property_Name 	=> 'Power'),
				c_Control_Muting 			=> array(c_Property_Name 	=> 'Mute'),
				c_Control_Volume 			=> array(c_Property_Name 	=> 'Lautstärke'),
				c_Control_Group				=> array(c_Property_Name 	=> 'Klangeinstellungen', c_Property_Icon => 'Gear'),
	      ...
	      // -------------------------------------------------------------------------------------------------------
			c_Room_6 => array(
				c_Property_Name 			=> AM_CONFIG_ROOMNAME6,
				c_Control_RoomPower 		=> array(c_Property_Name 	=> 'Power'),
				c_Control_Muting 			=> array(c_Property_Name 	=> 'Mute'),
				c_Control_Volume 			=> array(c_Property_Name 	=> 'Lautstärke'),
				c_Control_Group				=> array(c_Property_Name 	=> 'Klangeinstellungen', c_Property_Icon => 'Gear'),
	...
	function get_DeviceConfiguration () {
		return array (
	      ...
	      // -------------------------------------------------------------------------------------------------------
			c_Device_AudioMax5 	=> array(
				c_Property_Name 		=> 'AudioMax 5',
				c_Control_DevicePower 	=> array(
					c_Property_Name 		=> 'Power',
					c_Property_CommPowerOn	=> array(c_Comm_AudioMax, 'SetPower', '4', '1'),
					c_Property_CommPowerOff	=> array(c_Comm_AudioMax, 'SetPower', '4', '0'),
				),
				c_Control_Muting 		=> array(
					c_Property_Name 		=> 'Mute',
					c_Property_CommMuteOn 	=> array(c_Comm_AudioMax, 'SetMute', '4', '1'),
					c_Property_CommMuteOff 	=> array(c_Comm_AudioMax, 'SetMute', '4', '0'),
				),
				c_Control_Volume 		=> array(
					c_Property_Name 		=> 'Volume', c_Property_MinValue => 0, c_Property_MaxValue => 100, c_Property_Limit => 80,
					c_Property_CommVol 		=> array(c_Comm_AudioMax, 'SetVolume', '4', c_Template_Value),
				),
				c_Control_Balance 		=> array(
					c_Property_Name 		=> 'Balance', c_Property_MinValue => 0, c_Property_MaxValue => 100,
					c_Property_CommBal 		=> array(c_Comm_AudioMax, 'SetBalance', '4', c_Template_Value),
				),
				c_Control_Treble 		=> array(
					c_Property_Name 		=> 'Höhen', c_Property_MinValue => 0, c_Property_MaxValue => 100,
					c_Property_CommTre 		=> array(c_Comm_AudioMax, 'SetTreble', '4', c_Template_Value),
				),
				c_Control_Middle 		=> array(
					c_Property_Name 		=> 'Mitten', c_Property_MinValue => 0, c_Property_MaxValue => 100,
					c_Property_CommMid 		=> array(c_Comm_AudioMax, 'SetMiddle', '4', c_Template_Value),
				),
				c_Control_Bass 			=> array(
					c_Property_Name 		=> 'Bass', c_Property_MinValue => 0, c_Property_MaxValue => 100,
					c_Property_CommBas 		=> array(c_Comm_AudioMax, 'SetBass', '4', c_Template_Value),
				),
			),
	      // -------------------------------------------------------------------------------------------------------
			c_Device_AudioMax6 	=> array(
				c_Property_Name 		=> 'AudioMax 6',
				c_Control_DevicePower 	=> array(
					c_Property_Name 		=> 'Power',
					c_Property_CommPowerOn	=> array(c_Comm_AudioMax, 'SetPower', '5', '1'),
					c_Property_CommPowerOff	=> array(c_Comm_AudioMax, 'SetPower', '5', '0'),
				),
				c_Control_Muting 		=> array(
					c_Property_Name 		=> 'Mute',
					c_Property_CommMuteOn 	=> array(c_Comm_AudioMax, 'SetMute', '5', '1'),
					c_Property_CommMuteOff 	=> array(c_Comm_AudioMax, 'SetMute', '5', '0'),
				),
				c_Control_Volume 		=> array(
					c_Property_Name 		=> 'Volume', c_Property_MinValue => 0, c_Property_MaxValue => 100, c_Property_Limit => 80,
					c_Property_CommVol 		=> array(c_Comm_AudioMax, 'SetVolume', '5', c_Template_Value),
				),
				c_Control_Balance 		=> array(
					c_Property_Name 		=> 'Balance', c_Property_MinValue => 0, c_Property_MaxValue => 100,
					c_Property_CommBal 		=> array(c_Comm_AudioMax, 'SetBalance', '5', c_Template_Value),
				),
				c_Control_Treble 		=> array(
					c_Property_Name 		=> 'Höhen', c_Property_MinValue => 0, c_Property_MaxValue => 100,
					c_Property_CommTre 		=> array(c_Comm_AudioMax, 'SetTreble', '5', c_Template_Value),
				),
				c_Control_Middle 		=> array(
					c_Property_Name 		=> 'Mitten', c_Property_MinValue => 0, c_Property_MaxValue => 100,
					c_Property_CommMid 		=> array(c_Comm_AudioMax, 'SetMiddle', '5', c_Template_Value),
				),
				c_Control_Bass 			=> array(
					c_Property_Name 		=> 'Bass', c_Property_MinValue => 0, c_Property_MaxValue => 100,
					c_Property_CommBas 		=> array(c_Comm_AudioMax, 'SetBass', '5', c_Template_Value),
				),
			),
	      // -------------------------------------------------------------------------------------------------------
	      ...
	      // -------------------------------------------------------------------------------------------------------
			c_Room_5 => array(
				0 	=> array(
					...
					c_Property_Input => 		array(c_Property_Device 	=> c_Device_NetPlayer),
		 			c_Property_Output => 	array(	c_Property_Device 	=> c_Device_AudioMax4,
													c_Property_CommSrc	=> array(c_Comm_AudioMax, 'SetSource', '4', '0')),
				),
				1 	=> array(
					c_Property_Name 	=> AM_CONFIG_INPUTNAME2,
		 			c_Property_Output => 	array(	c_Property_Device 	=> c_Device_AudioMax4,
													c_Property_CommSrc	=> array(c_Comm_AudioMax, 'SetSource', '4', '1')),
				),
				2 	=> array(
					c_Property_Name 	=> AM_CONFIG_INPUTNAME3,
		 			c_Property_Output => 	array(	c_Property_Device 	=> c_Device_AudioMax4,
													c_Property_CommSrc	=> array(c_Comm_AudioMax, 'SetSource', '4', '2')),
				),
				3 	=> array(
					c_Property_Name 	=> AM_CONFIG_INPUTNAME4,
		 			c_Property_Output => 	array(	c_Property_Device 	=> c_Device_AudioMax4,
													c_Property_CommSrc	=> array(c_Comm_AudioMax, 'SetSource', '4', '3')),
				),
			),
	      // -------------------------------------------------------------------------------------------------------
			c_Room_6 => array(
				0 	=> array(
					...
					c_Property_Input => 		array(c_Property_Device 	=> c_Device_NetPlayer),
		 			c_Property_Output => 	array(	c_Property_Device 	=> c_Device_AudioMax4,
													c_Property_CommSrc	=> array(c_Comm_AudioMax, 'SetSource', '5', '0')),
				),
				1 	=> array(
					c_Property_Name 	=> AM_CONFIG_INPUTNAME2,
		 			c_Property_Output => 	array(	c_Property_Device 	=> c_Device_AudioMax4,
													c_Property_CommSrc	=> array(c_Comm_AudioMax, 'SetSource', '5', '1')),
				),
				2 	=> array(
					c_Property_Name 	=> AM_CONFIG_INPUTNAME3,
		 			c_Property_Output => 	array(	c_Property_Device 	=> c_Device_AudioMax4,
													c_Property_CommSrc	=> array(c_Comm_AudioMax, 'SetSource', '5', '2')),
				),
				3 	=> array(
					c_Property_Name 	=> AM_CONFIG_INPUTNAME4,
		 			c_Property_Output => 	array(	c_Property_Device 	=> c_Device_AudioMax4,
													c_Property_CommSrc	=> array(c_Comm_AudioMax, 'SetSource', '5', '3')),
				),
			),
	      // -------------------------------------------------------------------------------------------------------
		);
