  ...
  <body>
	<div id="containerTop">
		<?
			...
			$Program = get_DeviceControlValue(c_Device_OnkyoTuner, c_Control_Program);
			$Names   = get_DeviceControlConfigValue(c_Device_OnkyoTuner, c_Control_Program, c_Property_Names);
			$Codes   = get_DeviceControlConfigValue(c_Device_OnkyoTuner, c_Control_Program, c_Property_Codes2);
			$Device  = c_Device_OnkyoTuner;
		?>
		<table  width=100%>
		  <tr>
			<th id="rc_cmd_prev" rc_program="prev" rc_devicename="<?php echo $Device;?>"  class="rc_button">Program -</th>
			<th id="rc_cmd_next" rc_program="next" rc_devicename="<?php echo $Device;?>"  class="rc_button">Program +</th>
		  </tr>
		</table>
