	...
	<body>
		...
		<div id="containerBottomLeft">
			<table width=100%>
				...
				<tr>
					<th id="rc_cmd_Display" rc_name="PanasonicRC2" rc_button="Display" class="rc_button33" >Display</th>
					<th id="rc_cmd_Audio"   rc_name="PanasonicRC2" rc_button="Audio"   class="rc_button33" >Audio</th>
					<th id="rc_cmd_Drive"   rc_name="PanasonicRC2" rc_button="DriveSelect"   class="rc_button33" >Drive Select</th>
				</tr>
			</table>
		</div> 
