	...
	<script type="text/javascript">
		...
		function refresh_currenttime(data) {
		 ...
		 function refresh_trackdata() {
			...
			$.get(serverAddr+"/user/NetPlayer2/NetPlayer_Receiver.php?rc_action=rc_other&id=rc_mp_length", refresh_totaltime);
			$.get(serverAddr+"/user/NetPlayer2/NetPlayer_Receiver.php?rc_action=rc_other&id=rc_mp_current", refresh_currenttime);
			$("#rc_mp_interpret").load(serverAddr+"/user/NetPlayer2/NetPlayer_Receiver.php",{id: "rc_mp_interpret", rc_action: "rc_other"});
			$("#rc_mp_album").load(serverAddr+"/user/NetPlayer2/NetPlayer_Receiver.php",{id: "rc_mp_album", rc_action: "rc_other"});
			$("#rc_mp_titel").load(serverAddr+"/user/NetPlayer2/NetPlayer_Receiver.php",{id: "rc_mp_titel", rc_action: "rc_other"});
			$.get(serverAddr+"/user/NetPlayer2/NetPlayer_Receiver.php?rc_action=rc_other&id=rc_mp_status", refresh_playerstatus);
		}
		...
		function refresh_radiodata() {
			...
			$.get(serverAddr+"/user/NetPlayer2/NetPlayer_Receiver.php?rc_action=other&id=rc_mp_status", refresh_radiostatus);
		}
