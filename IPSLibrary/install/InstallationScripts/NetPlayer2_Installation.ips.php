<?
	...
	IPSUtils_Include ("NetPlayer_Constants.inc.php",     "IPSLibrary::app::modules::NetPlayer2");
	...
	$remoteControlId       = CreateVariable("RemoteControl",   3 /*String*/,   $CategoryIdData, 310 , '~HTMLBox', null, '<iframe frameborder="0" width="100%" src="../user/NetPlayer2/NetPlayer_MP3Control.php" height=255px </iframe>');
	$mobileControlId       = CreateVariable("MobileControl",   3 /*String*/,   $CategoryIdData, 320 , '~HTMLBox', null, '<iframe frameborder="0" width="100%" src="../user/NetPlayer2/NetPlayer_Mobile.php" height=1000px </iframe>');


	// Register Variable Constants
	SetVariableConstant ("NP_ID_CDCATEGORYNAME",  $cdCategoryNameId,       'NetPlayer_IDs.inc.php', 'IPSLibrary::app::modules::NetPlayer2');
	SetVariableConstant ("NP_ID_CDDIRECTORYPATH", $cddirectoryPath,        'NetPlayer_IDs.inc.php', 'IPSLibrary::app::modules::NetPlayer2');
	SetVariableConstant ("NP_ID_CDDIRECTORYNAME", $cddirectoryName,        'NetPlayer_IDs.inc.php', 'IPSLibrary::app::modules::NetPlayer2');
	SetVariableConstant ("NP_ID_CDDIRECTORYIDX",  $cdIdxId,                'NetPlayer_IDs.inc.php', 'IPSLibrary::app::modules::NetPlayer2');
	SetVariableConstant ("NP_ID_CDTRACKLISTHTML", $cdTrackListHtmlId,      'NetPlayer_IDs.inc.php', 'IPSLibrary::app::modules::NetPlayer2');
	SetVariableConstant ("NP_ID_CDTRACKIDX",      $cdTrackIdxId,           'NetPlayer_IDs.inc.php', 'IPSLibrary::app::modules::NetPlayer2');

	SetVariableConstant ("NP_ID_RADIONAME",       $radioNameId,            'NetPlayer_IDs.inc.php', 'IPSLibrary::app::modules::NetPlayer2');
	SetVariableConstant ("NP_ID_RADIOURL",        $radioUrlId,             'NetPlayer_IDs.inc.php', 'IPSLibrary::app::modules::NetPlayer2');
	SetVariableConstant ("NP_ID_RADIOIDX",        $radioIdxId,             'NetPlayer_IDs.inc.php', 'IPSLibrary::app::modules::NetPlayer2');

	SetVariableConstant ("NP_ID_POWER",           $powerId,                'NetPlayer_IDs.inc.php', 'IPSLibrary::app::modules::NetPlayer2');
	SetVariableConstant ("NP_ID_REMOTECONTROL",   $remoteControlId,        'NetPlayer_IDs.inc.php', 'IPSLibrary::app::modules::NetPlayer2');
	SetVariableConstant ("NP_ID_MOBILECONTROL",   $mobileControlId,        'NetPlayer_IDs.inc.php', 'IPSLibrary::app::modules::NetPlayer2');
	SetVariableConstant ("NP_ID_CONTROLTYPE",     $controlTypeId,          'NetPlayer_IDs.inc.php', 'IPSLibrary::app::modules::NetPlayer2');
	SetVariableConstant ('"NP_ID_CDALBUM"',       $albumId,                'NetPlayer_IDs.inc.php', 'IPSLibrary::app::modules::NetPlayer2');
	SetVariableConstant ("NP_ID_CDINTERPRET",     $interpretId,            'NetPlayer_IDs.inc.php', 'IPSLibrary::app::modules::NetPlayer2');

	SetVariableConstant ("NP_ID_CATEGORYLIST",    $categoryId,             'NetPlayer_IDs.inc.php', 'IPSLibrary::app::modules::NetPlayer2');
	SetVariableConstant ("NP_ID_CDALBUMLIST",     $cdAlbumListId,          'NetPlayer_IDs.inc.php', 'IPSLibrary::app::modules::NetPlayer2');
	SetVariableConstant ("NP_ID_CDALBUMNAV",      $cdAlbumNavId,           'NetPlayer_IDs.inc.php', 'IPSLibrary::app::modules::NetPlayer2');
	SetVariableConstant ('"NP_ID_CDTRACKLIST"',   $cdTrackListId,          'NetPlayer_IDs.inc.php', 'IPSLibrary::app::modules::NetPlayer2');
	SetVariableConstant ("NP_ID_CDTRACKNAV",      $cdTrackNavId,           'NetPlayer_IDs.inc.php', 'IPSLibrary::app::modules::NetPlayer2');
	SetVariableConstant ("NP_ID_RADIOLIST",       $radioListId,            'NetPlayer_IDs.inc.php', 'IPSLibrary::app::modules::NetPlayer2');
	SetVariableConstant ("NP_ID_RADIONAV",        $radioNavId,             'NetPlayer_IDs.inc.php', 'IPSLibrary::app::modules::NetPlayer2');
	SetVariableConstant ("NP_ID_SOURCE",          $sourceId,               'NetPlayer_IDs.inc.php', 'IPSLibrary::app::modules::NetPlayer2');
	SetVariableConstant ('"NP_ID_CONTROL"',       $controlId,              'NetPlayer_IDs.inc.php', 'IPSLibrary::app::modules::NetPlayer2');
