<?
	 ...
	 * @{
	 *
	 * @file          IPSComponentCam_DLink932.class.php
	 * @author        Andreas Brauneis
	 *
	 */

	/**
    * @class IPSComponentCam_DLink932
    *
    * Definiert ein IPSComponentCam Object, das die Funktionen einer Cam Componente für eine 
    * DLink932 Kamera implementiert
    *
    * @author Andreas Brauneis
    * @version
    ...
    */
	...
	class IPSComponentCam_DLink932 extends IPSComponentCam {
		 ...
		 * @public
		 *
		 * Initialisierung eines IPSComponentCam_DLink932 Objektes
		 *
		...
		public function Get_URLPicture($size=IPSCOMPONENTCAM_SIZE_MIDDLE) {
			$url = 'http://'.$this->ipAddress.'/image/jpeg.cgi?user='.$this->username.'&password='.$this->password;
			switch ($size) {
				case  IPSCOMPONENTCAM_SIZE_SMALL:
					$url .= ''; // Not supported
					break;
