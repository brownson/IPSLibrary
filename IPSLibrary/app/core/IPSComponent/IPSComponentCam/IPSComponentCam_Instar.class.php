<?
	 ...
	 * @{
	 *
	 * @file          IPSComponentCam_Axis.class.php
	 * @author        Andreas Brauneis
	 *
	 */

	/**
    * @class IPSComponentCam_Instar
    *
    * Definiert ein IPSComponentCam Object, das die Funktionen einer Cam Componente für eine 
    * Instar Kamera implementiert
    *
    * @author Andreas Brauneis
    * @version
    ...
    */
	...
	class IPSComponentCam_Instar extends IPSComponentCam {
		 ...
		 * @public
		 *
		 * Initialisierung eines IPSComponentCam_Instar Objektes
		 *
		...
		public function Get_URLPicture($size=IPSCOMPONENTCAM_SIZE_MIDDLE) {
			...
			$url = 'http://'.$this->ipAddress.'/snapshot.cgi?user='.$this->username.'&pwd='.$this->password.'&next_url=snapshot.jpg';
			/*
			switch ($size) {
				case  IPSCOMPONENTCAM_SIZE_SMALL:
      ...
      IPS_LogMessage	("...",$url);
		...
		public function Get_URL($urlType) {
			...
			switch ($urlType) {
				...
				default:
					trigger_error('Diese Funktion ist für eine Instar Kamera noch NICHT implementiert !!!');
			}
