<?
     ...
     * @{
     *
     * @file          IPSComponentCam_Foscam.class.php
     * @author        Andreas Brauneis
     *
     */

    /**
    * @class IPSComponentCam_Foscam
    *
    * Definiert ein IPSComponentCam Object, das die Funktionen einer Cam Componente für eine
    * Foscam Kamera implementiert
    *
    * @author Andreas Brauneis
    * @version
    *   Version 2.50.1, 16.03.2013<br/>
    */
    ...
    class IPSComponentCam_Foscam extends IPSComponentCam {
         ...
         * @public
         *
         * Initialisierung eines IPSComponentCam_Foscam Objektes
         *
        ...
        public function Get_URLLiveStream($size=IPSCOMPONENTCAM_SIZE_MIDDLE) {
            $url = 'http://'.$this->ipAddress.'/cgi-bin/CGIStream.cgi?cmd=GetMJStream&usr='.$this->username.'&pwd='.$this->password;
        ...
        public function Get_URLPicture($size=IPSCOMPONENTCAM_SIZE_MIDDLE) {
            ...
            $url = 'http://'.$this->ipAddress.'/cgi-bin/CGIProxy.fcgi?cmd=snapPicture2&usr='.$this->username.'&pwd='.$this->password;
            /*
            switch ($size) {
                case  IPSCOMPONENTCAM_SIZE_SMALL:
      ...
      */
      IPS_LogMessage    ("...",$url);
        ...
        public function Get_URL($urlType) {
                $url = 'http://'.$this->ipAddress.'/cgi-bin/CGIProxy.fcgi?';
            ...
            switch ($urlType) {
                    ...
                    case IPSCOMPONENTCAM_URL_MOVEDOWN:
                        $url = 'cmd=ptzMoveDown';
                        break;
                    case IPSCOMPONENTCAM_URL_STOP:
                        $url = 'cmd=ptzStopRun';
                        break;
                    case IPSCOMPONENTCAM_URL_PREDEFPOS1:
                        $url = 'cmd=ptzGotoPresetPoint';
                        break;
                ...
                default:
                    trigger_error('Diese Funktion ist für eine Foscam Kamera noch NICHT implementiert !!!');
            }
