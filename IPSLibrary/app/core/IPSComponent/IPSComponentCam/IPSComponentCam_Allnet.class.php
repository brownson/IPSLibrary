<?
	 ...
	 * @{
	 *
	 * @file          IPSComponentCam_Allnet.class.php
	 * @author        Andreas Brauneis
	 *
	 */

	/**
    * @class IPSComponentCam_Allnet
    *
    * Definiert ein IPSComponentCam Object, das die Funktionen einer Cam Componente für eine 
    * Allnet Kamera implementiert
    *
    * @author Andreas Brauneis
    * @version
    ...
    */
	...
	class IPSComponentCam_Allnet extends IPSComponentCam {
		 ...
		 * @public
		 *
		 * Initialisierung eines IPSComponentCam_Allnet Objektes
		 *
		...
		public function Get_URLLiveStream($size=IPSCOMPONENTCAM_SIZE_MIDDLE) {
			$url = 'http://'.$this->username.':'.$this->password.'@'.$this->ipAddress.'/cgi/mjpg/mjpg.cgi';
			switch ($size) {
		...
		public function Get_URLPicture($size=IPSCOMPONENTCAM_SIZE_MIDDLE) {
			$url = 'http://'.$this->username.':'.$this->password.'@'.$this->ipAddress.'/cgi/jpg/image.cgi';
			switch ($size) {
				case  IPSCOMPONENTCAM_SIZE_SMALL:
					$url .= ''; // Not supported
					break;
		...
		public function Get_URL($urlType) {
			...
			switch ($urlType) {
					...
					case IPSCOMPONENTCAM_URL_PREDEFPOS5:
						...
						break;
				default:
					trigger_error('Diese Funktion ist für eine Allnet Kamera noch NICHT implementiert !!!');
			}
			return $url;
		}
