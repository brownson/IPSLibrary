<?
	 ...
	 * @{
	 *
	 * @file          IPSPowerControl_NavigateNext.inc.php
	...
	$variableId   = IPSUtil_ObjectIDByPath('Program.IPSLibrary.data.modules.IPSPowerControl.Common.'.IPSPC_VAR_TYPEOFFSET);
	$value        = IPSPC_OFFSET_NEXT;
