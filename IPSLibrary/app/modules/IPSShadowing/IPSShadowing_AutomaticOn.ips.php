<?
	 ...
	 * @{
	 *
	 * @file          IPSShadowing_AutomaticOn.ips.php
	 * @author        Andreas Brauneis
	 * @version
	 * Version 2.50.1, 21.03.2012<br/>
	 *
	 * Aktivieren des Automatic Modus für alle Beschattungs Elemente
	 */
	...
	foreach($deviceIds as $deviceId) {
	   ...
	   $device->ChangeSetting(IPS_GetObjectIDByIdent(c_Control_Automatic, $deviceId), true);
	}
