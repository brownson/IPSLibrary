<?
	 ...
	 * @{
	 *
	 * @file          IPSShadowing_AutomaticReset.ips.php
	 * @author        Andreas Brauneis
	 * @version
	 * Version 2.50.1, 21.03.2012<br/>
	 *
	 * Reset aller "ManualChange" Flags
	 */
	...
	foreach($deviceIds as $deviceId) {
	   ...
	   $device->ChangeSetting(IPS_GetObjectIDByIdent(c_Control_ManualChange, $deviceId), false);
	}
	/** @}*/
?>