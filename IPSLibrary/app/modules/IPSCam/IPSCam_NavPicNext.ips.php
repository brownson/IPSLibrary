<?
	 ...
	 * @{
	 *
	 * @file          IPSCam_NavPicNext.ips.php
	...
	$variableId   = IPSUtil_ObjectIDByPath('Program.IPSLibrary.data.modules.IPSCam.Common.'.IPSCAM_VAR_NAVPICT);
	$value        = IPSCAM_NAV_FORWARD;
