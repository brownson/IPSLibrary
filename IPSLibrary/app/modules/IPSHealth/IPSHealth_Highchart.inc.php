<?
	$version = "2.01B"; $versionDate = "18.05.2012";
 	...
 	function CheckCfgDaten($cfg)
	{
      DebugModuleName($cfg,"CheckCfgDaten");
   	...
   	if ($cfg['Ips']['ChartType'] != 'Highcharts' && $cfg['Ips']['ChartType'] != 'Highstock')
		...
		if ($IPS_SENDER != "WebInterface" && $cfg['RunMode'] != "popup" && $cfg['RunMode'] != "dashboard" )
	...
	function CheckCfg_Common($cfg)
 	{
      DebugModuleName($cfg,"CheckCfg_Common");
		...
		if ($cfg['RunMode'] == "dashboard")
		{
			if (!isset($cfg['Ips']['Dashboard']['Ip']))
				die ("Abbruch - Konfiguration von ['Ips']['Dashboard']['Ip'] fehlt.");
			if (!isset($cfg['Ips']['Dashboard']['Port']))
				die ("Abbruch - Konfiguration von ['Ips']['Dashboard']['Port'] fehlt.");
		}
